...
export const getAllReviews = (spotId) => async (dispatch) => {
    const response = await csrfFetch(`https://airbnb-api-docs.onrender.com/spots/${spotId}/reviews`);
    if (response.ok) {
...
export const deleteReview = (reviewId) => async (dispatch) => {
    const response = await csrfFetch(`https://airbnb-api-docs.onrender.com/reviews/${reviewId}`, {
        method: "DELETE", 
    })
    if (response.ok) {
