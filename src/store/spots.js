...
export const getAllSpots = () => async (dispatch) => {
    const response = await fetch("https://airbnb-api-docs.onrender.com/spots");
    if (response.ok) {
  ...
  export const getSpotDetails = (spotId) => async (dispatch) => {
    const response = await csrfFetch(`https://airbnb-api-docs.onrender.com/spots/${spotId}`);
    if (response.ok) {
  ...
  export const getUserSpots = () => async (dispatch) => {
    const response = await csrfFetch("https://airbnb-api-docs.onrender.com/spots/current");
    if (response.ok) {
  ...
  export const addNewSpot = (spot, navigate) => async () => {
    const response = await csrfFetch(`https://airbnb-api-docs.onrender.com/spots`, {
      method: "POST",
  ...
  export const addSpotImage = (spotId, image) => async (dispatch) => {
    const response = await csrfFetch(`https://airbnb-api-docs.onrender.com/spots/${spotId}/images`, {
      method: "POST",
      headers: {
